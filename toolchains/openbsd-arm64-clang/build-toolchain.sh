...
PREFIX="/tmp/gnustep-cli-openbsd-arm64-toolchain/install"
SOURCES_DIR="/tmp/gnustep-cli-openbsd-arm64-toolchain/sources"
BUILD_ROOT="/tmp/gnustep-cli-openbsd-arm64-toolchain/build"
HOST_OS="openbsd"
