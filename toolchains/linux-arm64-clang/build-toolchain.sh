...
PREFIX="/tmp/gnustep-cli-linux-arm64-toolchain/install"
SOURCES_DIR="/tmp/gnustep-cli-linux-arm64-toolchain/sources"
BUILD_ROOT="/tmp/gnustep-cli-linux-arm64-toolchain/build"
HOST_OS="linux"
